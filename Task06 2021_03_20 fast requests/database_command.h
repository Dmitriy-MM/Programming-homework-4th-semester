...
private:
	...
	List_2t_node<Database_link_node*> * choosing (AVLt_tree_node<Database_link_node*> * sub_head, int (*cmp) (Database_link_node*, Database_link_node*, void *), void * cmp_arg);
	List_2t_node<Database_link_node*> * apply_to_avl_subtree (AVLt_tree_node<Database_link_node*> * sub_head, int (*cmp) (Database_link_node*, Database_link_node*, void *), void * cmp_arg);
