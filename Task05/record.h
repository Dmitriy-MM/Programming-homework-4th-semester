...
public:
	...
	int operator== (const Record& r)
	{
		...
		// static int cmp_phone (Record& r1, Record& r2)
		// {
			// return r1.get_phone () - r2.get_phone ();
		// }
		// static int cmp_group (Record& r1, Record& r2)
		// {
			// return r1.get_group () - r2.get_group ();
		// }
		// static int cmp_name (Record& r1, Record& r2)
		// {
			// if (!(r1.name && r2.name))
				// return 0;
