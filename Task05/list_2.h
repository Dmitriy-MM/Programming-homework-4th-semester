...
*	
*	ToDo: 
*	int add (List_2_node<T>&); - sdelano insert
*	int rm (List_2_node<T>&); - sdevalano remove
*	
*	@List_2_node:
*	swap (List_2_node<T>&); 
*/
...
public:
	...
	//List_2_node (T& x): T (x) { next = nullptr;	prev = nullptr; };
...
private:
	...
	// List_2_node<T> * merge_with (List_2_node<T> * head_A, List_2_node<T> * head_B, List_2_node<T> * last);
	// List_2_node<T> * join (List_2_node<T> *, List_2_node<T> *);
#endif
public:
	enum RET_CODES {
		SUCCESS = 0,
